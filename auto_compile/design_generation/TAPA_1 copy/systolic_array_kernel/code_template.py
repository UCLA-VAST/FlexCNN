...
def top_function(desp, config):
	...
	code.append(indent(1) + '  bus_mem_1 dram_b1,\n')
...
def flexcnn_fifos(desp, config):
	code = []
	code.append(indent(1)+'tapa::stream<CinLoadData0Type, 128> fifo_cin_load("fifo_cin_load");\n')
	code.append(indent(1)+'tapa::stream<CinLoadData0Type, 128> fifo_cin_prev_0("fifo_cin_prev_0");\n')
	code.append(indent(1)+'tapa::stream<CinLoadData0Type, 128> fifo_beta_conv("fifo_beta_conv");\n')
	code.append(indent(1)+'tapa::stream<CinLoadData0Type, 128> fifo_gamma_conv("fifo_gamma_conv");\n')
	code.append(indent(1)+'tapa::stream<CinLoadData0Type, 128> fifo_weight_load("fifo_weight_load");\n')
	code.append(indent(1)+'tapa::stream<CinLoadData0Type, 128> fifo_pool_0("fifo_pool_0");\n')
	code.append(indent(1)+'tapa::stream<CinLoadData0Type, 128> fifo_upsample_0("fifo_upsample_0");\n')
	code.append(indent(1)+'tapa::stream<CinLoadData0Type, 128> fifo_concat_0("fifo_concat_0");\n')
	code.append(indent(1)+'tapa::stream<CinLoadData0Type, 128> fifo_concat_1("fifo_concat_1");\n')
	code.append(indent(1)+'tapa::stream<CinLoadData0Type, 128> fifo_add_0("fifo_add_0");\n')
	code.append(indent(1)+'tapa::stream<CinLoadData0Type, 128> fifo_relu_0("fifo_relu_0");\n')
	code.append(indent(1)+'tapa::stream<CinLoadData0Type, 128> fifo_SA("fifo_SA");\n')
	code.append(indent(1)+'\n')
	code.append(indent(1)+'tapa::stream<ConfigInst,16> config_prev_load("config_prev_load");\n')
	code.append(indent(1)+'tapa::stream<ConfigInst,16> config_bias_load("config_bias_load");\n')
	code.append(indent(1)+'tapa::stream<ConfigInst,16> config_weight_load("config_weight_load");\n')
	code.append(indent(1)+'tapa::stream<ConfigInst,16> config_SA("config_SA");\n')
	code.append(indent(1)+'tapa::stream<ConfigInst,16> config_upsample("config_upsample");\n')
	code.append(indent(1)+'tapa::stream<ConfigInst,16> config_pool("config_pool");\n')
	code.append(indent(1)+'tapa::stream<ConfigInst,16> config_concat("config_concat");\n')
	code.append(indent(1)+'tapa::stream<ConfigInst,16> config_add("config_add");\n')
	code.append(indent(1)+'tapa::stream<ConfigInst,16> config_relu("config_relu");\n')
	code.append(indent(1)+'tapa::stream<ConfigInst,16> config_data_write("config_data_write");\n')
	code.append(indent(1)+'\n')
...
def flexcnn_tasks_before_SA(desp, config):
	code = []
	code.append(indent(1)+'tapa::task()\n')
	code.append(indent(1)+'.invoke(cin_load, \n')
	code.append(indent(1)+'    start_inst, end_inst,\n')
	code.append(indent(1)+'		dram_b0, \n')
	code.append(indent(1)+'		layer_config,\n')
	code.append(indent(1)+'		fifo_cin_load, \n')
	code.append(indent(1)+'		config_prev_load,\n')
	code.append(indent(1)+'    cout_to_cin_sync, cin_to_cout_sync\n')
	code.append(indent(1)+')\n')
	code.append(indent(1)+'.invoke(cin_load_prev,\n')
	code.append(indent(1)+'    start_inst, end_inst,\n')
	code.append(indent(1)+'    dram_b0,\n')
	code.append(indent(1)+'		config_prev_load,\n')
	code.append(indent(1)+'		fifo_cin_prev_0,\n')
	code.append(indent(1)+'		config_bias_load\n')
	code.append(indent(1)+')\n')
	code.append(indent(1)+'.invoke(bias_load,\n')
	code.append(indent(1)+'    start_inst, end_inst,\n')
	code.append(indent(1)+'    dram_b1,\n')
	code.append(indent(1)+'		config_bias_load,\n')
	code.append(indent(1)+'    fifo_beta_conv, fifo_gamma_conv,\n')
	code.append(indent(1)+'		config_weight_load\n')
	code.append(indent(1)+')\n')
	code.append(indent(1)+'.invoke(weight_load,\n')
	code.append(indent(1)+'    start_inst, end_inst,\n')
	code.append(indent(1)+'    dram_b1,\n')
	code.append(indent(1)+'		config_weight_load,\n')
	code.append(indent(1)+'		fifo_weight_load,\n')
	code.append(indent(1)+'		config_SA\n')
	code.append(indent(1)+')\n')
	return code
...
def kernel_tasks(desp, config):
	...
	#   code.append(indent(2) + 'fifo%d_shim,\n' % (idx))
		if idx == 0:
			...
			code.append(indent(2) + 'fifo_cin_load,\n')
		else:
			code.append(indent(2) + 'fifo_weight_load,\n')
 	...
 	#    code.append(indent(2) + '%sIN_NUM, %sOUT_NUM, %sIN_IMG_H, %sIN_IMG_W, %sOUT_IMG_H, %sOUT_IMG_W, FILTER_S_W,\n' % (var_prefix, var_prefix, var_prefix, var_prefix, var_prefix, var_prefix))
			code.append(indent(2) + 'config_SA,\n')
			code.append(indent(2) + 'config_upsample,\n')
		if idx == 0:
...
def loader(desp, config):
	...
	#     code.append(indent(1) + 'ap_uint<8> LAYER_FILTER_S_W,\n')
			...
			code.append('          out_num_iter += LAYER_OUT_NUM_T;\n')
			code.append('          if (out_num_iter >= LAYER_OUT_NUM){\n')
			code.append('            out_num_iter = 0;\n')
	...
	#   code.append(indent(2) + '}\n')
		...
		code.append('        in_num_iter = 0;\n')
		code.append('        out_num_iter += LAYER_OUT_NUM_T;\n')
		code.append('        if (out_num_iter >= LAYER_OUT_NUM_HW){\n')
		code.append('          out_num_iter = 0;\n')
		code.append('          in_w_iter += LAYER_IN_W_T;\n')
