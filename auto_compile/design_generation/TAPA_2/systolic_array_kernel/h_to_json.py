...
if __name__ == "__main__":
	...
	with open(prj_path + '/auto_compile/design_generation/TAPA/systolic_array_kernel/cnn_features.json', 'w') as outfile:
	...
	paramfile.append('#define CIN_SIZE 14193456\n')
	paramfile.append('#define WEIGHT_SIZE 560032\n')
...
#define BIAS_SIZE 16544
	...
	#print jsonfile to out.json
	with open(prj_path + '/auto_compile/design_generation/TAPA/design/src/params.h', 'w') as outfile:
